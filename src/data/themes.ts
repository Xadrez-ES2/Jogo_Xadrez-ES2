...
/**
 * Catálogo central de temas. Para adicionar uma nova paleta,
 * basta acrescentar um novo objeto `Theme` aqui e incluir o
 * `id` no union type `ThemeId` (src/types/theme.ts).
 *
 * Nenhum componente precisa mudar quando um tema é adicionado —
